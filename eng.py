...
if st.button("🎙️ Speak Now"):
    ...
    try:
        ...
        st.session_state["spoken_text"] = transcription_result["text"]
...
# Show transcribed text or allow manual input
user_input = st.text_input("Ask your medical question:", st.session_state["spoken_text"])
